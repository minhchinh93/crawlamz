...
// $url = 'https://www.amazon.com/dp/B09PNW7WZR/ref=sr_1_10?m=ATVPDKIKX0DER&qid=1641315251&refinements=p_6%3AATVPDKIKX0DER&s=apparel&sr=1-10';
    $url=  "http://api.scraperapi.com?api_key=42c47c6a09541770714ff92f7e00ba74&url=".$link;
    $curl = curl_init();
    if (! is_resource($curl)) {
...
$verbose = stream_get_contents($curlstderr);
    ...
    // Regex từ kết quả crawl được
       ...
       preg_match_all($re, $strss, $matchee, PREG_SET_ORDER, 0);
        // var_dump($matchee);
       $pnj = $matche[1][0];
       $link_pnj = "https://m.media-amazon.com/images/I/".$pnj[1][0]."?fbclid=IwAR0AL_AbagnH07PJLgs9UR-z_rwN8bGrhem5DkRVDbUh_xbe4fZIGgWrsl0";
